  ...
  return (
    ...
    >
      ...
      <div className="relative w-full min-w-0 max-w-none lg:hidden">
        <div className="mx-auto max-w-xl px-6 pb-0 pt-4 sm:px-8 sm:pb-0 sm:pt-5">
          {/* Eyebrow pill */}
          <div>
      ...
      <div className="relative hidden w-full max-lg:min-h-0 flex-col items-start lg:flex lg:min-h-full lg:flex-row lg:items-center">
