...
$categoryData = @{
    "corrugated-boxes.html" = @{
        "title"          = "Corrugated Boxes | Premium Custom Packaging | Brandsface"
    ...
    "kraft-paper.html" = @{
        "title"          = "Kraft Paper Packaging | Sustainable Custom Solutions | Brandsface"
    ...
    "gift-boxes.html" = @{
        "title"          = "Gift Boxes | Premium Custom Packaging | Brandsface"
    ...
    "custom-pouches.html" = @{
        "title"          = "Custom Pouches | Flexible Packaging Solutions | Brandsface"
    ...
    "labels-and-tags.html" = @{
        "title"           = "Labels & Tags | Premium Custom Solutions | Brandsface"
    ...
    "rigid-boxes.html"    = @{
        "title"          = "Rigid Boxes | Luxury Custom Packaging | Brandsface"
    ...
    "premium-finish.html" = @{
        "title"          = "Premium Finishes | Luxury Packaging Details | Brandsface"
